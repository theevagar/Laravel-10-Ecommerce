...
@section('title','Create Edit sub Category')
@section('content')
			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action=""  name="EditsubCateoryForm" id="EditsubCateoryForm">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
...
{{-- validation of subcategory form --}}
<script>
    $("#EditsubCateoryForm").submit(function(event){
        event.preventDefault();
        // var element = $(this);
        var element = $("#EditsubCateoryForm");
...
{{-- sub category name change dropdown --}}
<script>
