...
@section('title','Create Coupon EDit')
@section('content')
			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action="" method="POST" name="CouponFormEdit" id="CouponFormEdit">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{ $coupon->description }}</textarea>
                                                <p></p>
                                            </div>
...
{{-- validation of coupons form --}}
<script>


    $("#CouponFormEdit").submit(function(event){
