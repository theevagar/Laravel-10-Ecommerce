...
@section('title','Front Checkout Page')
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between summery-end">
                                    ...
                                    <div class="h6"><strong id="dicount_value">${{ $discount }}</strong></div>
                                </div>
                        ...
                        <div class="card payment-form ">
                            ...
                            <h3 class="cart-title h5 mb-5">Payment Method</h3>
                            <div class="">
        ...
        $.ajax({
                ...
                success: function(response){
                    ...
                    if(response.status == true)
                    {
                        $("#shippingAmount").html('$'+response.shippingCharge);
                        $("#grandTotal").html('$'+response.grandTotal);
                        $("#dicount_value").html('$'+response.discount);
