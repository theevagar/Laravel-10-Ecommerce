...
@section('title','Front Account Profile Order Page')
@section('content')
<main>
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-footer p-3">
                            ...
                            <!-- Heading -->
                            <h6 class="mb-7 h5 mt-4">Order Item({{ $orderItemsCount }})</h6>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="mb-4 fs-sm fw-bold">
                                                    <a class="text-body" href="#">{{ $item->name }} × {{ $item->qty }}</a> <br>
                    ...
                    <div class="card card-lg mb-5 mt-3">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li class="list-group-item d-flex">
                                    <span>Discount Code: {{ (!empty($order->coupon_code)) ? '(' .$order->coupon_code.')' : '' }}</span>
