                ...
                <div class="col-md-6">
                    <form class="shake" role="form" method="post" id="ContactForm" name="ContactForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control"  type="text" name="subject" id="subject"  data-error="Please enter your message subject">
                            <p class="help-block with-errors"></p>
                        </div>

                        <div class="mb-3">
                            <label for="message" class="mb-2">Message</label>
                            <textarea class="form-control" rows="3"  name="message" id="message"  data-error="Write your message"></textarea>
                            <p class="help-block with-errors"></p>
                        </div>
